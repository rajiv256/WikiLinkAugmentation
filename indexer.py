...
class Indexer(object):
    ...
    def split_dump(self):
        try:
            ...
            subprocess.call(["./bzip2recoverNew",
                             os.path.abspath(self.xmlbz2_path)])
        except:
            raise
        print ("Perfect, spliting complete. You should remove the original "
               "dumpfile.")

    #def subdirize(self):
    #    die("oops--this is for the special case where you have done an "
    #        "initial split, then want to make smaller files.")
